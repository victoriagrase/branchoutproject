...
This algorithm is implemented in Algorithm 1 for small tree instances where optimal classification trees of depth two with three nodes are computed. The input parameter is a data set $D$ consisting of positive $D^+$ and negative $D^-$ instances.
